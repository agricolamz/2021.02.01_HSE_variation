---
title: "Применение математических методов в лингвистике"
subtitle: "Исследование вариативности в Зиловском андийском"
author: "Г. А. Мороз, С. Ферхеес"
institute: "Международная лаборатория языковой конвергенции, НИУ ВШЭ"
date: |
    | 02 февраля 2021
    |
    | Презентацию можно скачать здесь: \alert{tinyurl.com/y3o5qkmw}    
...
# qrcode_gen("https://github.com/agricolamz/2021.02.01_HSE_variation/raw/master/2021.02.01_HSE_variation.pdf")
# dev.off()
...
## Когда "исследователи" найдут меньше вариативности?
...
* прескриптивная vs. дескриптивная лингвистика
* вариативность -- предмет исследования, а не пренебрежения (если понравилось -- пройдите опрос Вани Левина)
* вариативность можно описывать при помощи энтропии
* бутстрэп -- отличный способ получить более надежную статистическую оценку
